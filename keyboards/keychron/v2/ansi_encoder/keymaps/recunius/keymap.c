...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN0] = LAYOUT_ansi_67(
        ...
        KC_CAPS, KC_A,     KC_S,     KC_D,    KC_F,    KC_G,    KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_SCLN,  KC_QUOT,            KC_ENT,           KC_END,
        KC_LSFT,           KC_Z,     KC_X,    KC_C,    KC_V,    KC_B,    KC_PGDN, KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSFT, KC_UP,
        _______, KC_DEL,   KC_LALT,                             KC_SPC,                              KC_RALT,  TG(GAME), _______,  KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [GAME] = LAYOUT_ansi_67(
        ...
        KC_LSFT,           KC_Z,     KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,   KC_SLSH,            KC_RSFT, KC_UP,
        LT(_FNGAME, KC_SLSH), KC_BSLS,  KC_LALT,                             KC_SPC,                             KC_RALT,  _______,  _______, KC_LEFT, KC_DOWN, KC_RGHT),

    [_FNGAME] = LAYOUT_ansi_67(
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [_FNGAME]   = { ENCODER_CCW_CW(RGB_VAD, RGB_VAI)},
};
