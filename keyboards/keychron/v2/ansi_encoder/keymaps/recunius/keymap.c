...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN0] = LAYOUT_ansi_67(
        ...
        KC_LCTL, KC_HOME,  KC_END,   KC_D,    KC_F,    KC_G,    KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_SCLN,  KC_QUOT,            KC_ENT,           KC_END,
        KC_LSFT,           KC_INS,   KC_DEL,  KC_CAPS,    KC_V,    KC_B,    KC_PGDN, KC_M,    KC_COMM,  KC_DOT,   TG(_FN_HHKB0),            KC_RSFT, KC_UP,
    ...
    [_FN_GAME0] = LAYOUT_ansi_67(
        ...
        KC_LCTL, KC_A,     KC_S,     KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_QUOT,            KC_ENT,           KC_PGDN,
        KC_LSFT,           KC_Z,     KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,   KC_SLSH,            KC_RSFT, KC_UP,
        LT(_FN_GAME1, KC_INS), KC_BSLS,  KC_LALT,                             KC_SPC,                             KC_RALT,  _______,  _______, KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [_FN_GAME1] = LAYOUT_ansi_67(
        ...
        _______, KC_LWIN,  _______,                             KC_ESC,                            _______,  _______,  _______,  _______, _______, _______),

    [_FN_HHKB0] = LAYOUT_ansi_67(
        ...
        KC_LSFT,           KC_Z,     KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,   KC_SLSH,            KC_RSFT, KC_UP,
        MO(_FN_HHKB1), KC_LWIN, KC_LALT,                             LT(_FN_HHKB1, KC_SPC),                             KC_RALT,  _______, _______, KC_LEFT, KC_DOWN, KC_RGHT),

    [_FN_HHKB1] = LAYOUT_ansi_67(
        KC_ESC,  KC_F1,    KC_F2,    KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_BSLS,           KC_MUTE,
        KC_TAB,  KC_Q,     KC_W,     KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,     KC_PGUP,  KC_LBRC,  KC_RBRC,  KC_DEL,          KC_HOME,
        KC_LCTL, KC_HOME,  KC_END,   KC_D,    KC_F,    KC_G,    KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_SCLN,  KC_QUOT,            KC_ENT,           KC_END,
        KC_LSFT,           KC_INS,   KC_DEL,  KC_CAPS,    KC_V,    KC_B,    KC_PGDN, KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSFT, KC_UP,
        _______, KC_DEL,   KC_LALT,                             KC_SPC,                              KC_RALT,  TG(_FN_HHKB0), _______,  KC_LEFT, KC_DOWN, KC_RGHT),
};
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [_FN_HHKB0]   = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
    [_FN_HHKB1]   = { ENCODER_CCW_CW(RGB_VAD, RGB_VAI)},
};
...
bool rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
    for(int i=0; i < sizeof(layer_leds) / sizeof(uint8_t); i++) {
        switch(get_highest_layer(layer_state|default_layer_state)) {
            case _FN0:
                rgb_matrix_set_color(layer_leds[i], RGB_CORAL);
                break;
            case _FN1:
            ...
            case _FN_GAME0:
                ...
                break;
            case _FN_GAME1:
                rgb_matrix_set_color(layer_leds[i], RGB_TURQUOISE);
                break;
            case _FN_HHKB0:
                rgb_matrix_set_color(layer_leds[i], RGB_TEAL);
                break;
            case _FN_HHKB1:
                rgb_matrix_set_color(layer_leds[i], RGB_GOLD);
                break;
            default:
